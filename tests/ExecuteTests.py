...
class BasicRunTests(unittest.TestCase):
    ...
    def test_file_withouterror(self):
        self.assertEqual(pycreator_core.execute_file("print('oui')"), "oui\n")
        self.assertEqual(pycreator_core.execute_file("x = 3"), '')
        self.assertEqual(pycreator_core.execute_file("abs(-4)"), '')
        self.assertEqual(pycreator_core.execute_file("pow(2, 2)"), '')
    ...
    def test_file_withsyntaxerror(self):
        self.assertEqual(pycreator_core.execute_file("print)"), "  File \"code.py\", line 1\n    print)\n      "
                                                                "   ^\nSyntaxError: invalid syntax\n")
        self.assertEqual(pycreator_core.execute_file("x === 3"), "  File \"code.py\", line 1\n    x === 3\n    "
                                                                 "    ^\nSyntaxError: invalid syntax\n")
    ...
    def test_file_witherrorinexecution(self):
        self.assertEqual(pycreator_core.execute_file("print(y)"), "Traceback (most recent call last):\n  File \""
                                                                  "code.py\", line 1, in <module>\n    \"\"\"Utilities "
                                                                  "needed to emulate Python's interactive interpreter."
                                                                  "\nNameError: name 'y' is not defined\n")
        self.assertEqual(pycreator_core.execute_file("x = 3/0"), "Traceback (most recent call last):\n  File \""
                                                                 "code.py\", line 1, in <module>\n    \"\"\"Utilities "
                                                                 "needed to emulate Python's interactive interpreter."
                                                                 "\nZeroDivisionError: division by zero\n")
